...
<body>
    <form id="form1" runat="server" style="width: 500px; height: 500px">
        <div class="form-row">
            ...
            <div class="col" style="margin: 10px">
                <asp:TextBox ID="TextCustomerID" runat="server" placeholder="Customer ID number" Enabled="False" TextMode="Number"></asp:TextBox>
            </div>
        </div>
        <div class="form-row">
            <div class="col" style="margin: 10px">
        ...
        <div class="form-row">
            ...
            <div class="col" style="margin: 10px">
                <asp:TextBox ID="TextCustomerName" runat="server" placeholder="Customer name" ></asp:TextBox>
            </div>
        </div>
        <div class="form-row">
            <div class="col" style="margin: 10px">
        ...
        <div class="form-row">
            ...
            <div class="col" style="margin: 10px">
                <asp:TextBox ID="CustomerDateTime" runat="server" Enabled="False" placeholder="Customer password" TextMode="DateTime"></asp:TextBox>
            </div>
        </div>
        <div class="form-row">
            <div class="col" style="margin: 10px">
            ...
            <div class="col" style="margin: 10px">
                <asp:CheckBox ID="CustomerBusiness" runat="server" Enabled="True"/>
            </div>
        </div>
